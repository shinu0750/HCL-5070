...
```bash
~/Library/Android/sdk/emulator/emulator -avd Pixel_7 -no-snapshot-load -no-audio 2>&1 &
```
...
```bash
/Users/shuhsing/Library/Android/sdk/platform-tools/adb wait-for-device && /Users/shuhsing/Library/Android/sdk/platform-tools/adb shell getprop sys.boot_completed
```
...
```bash
/Users/shuhsing/Library/Android/sdk/platform-tools/adb -s emulator-5554 shell monkey -p com.lotus.sync.traveler -c android.intent.category.LAUNCHER 1
sleep 5
```
...
```bash
/Users/shuhsing/Library/Android/sdk/platform-tools/adb -s emulator-5554 shell settings put system accelerometer_rotation 0
/Users/shuhsing/Library/Android/sdk/platform-tools/adb -s emulator-5554 shell wm user-rotation lock 1
/Users/shuhsing/Library/Android/sdk/platform-tools/adb -s emulator-5554 shell settings put system user_rotation 1
sleep 2
```
...
```bash
/Users/shuhsing/Library/Android/sdk/platform-tools/adb -s emulator-5554 shell screencap -p /sdcard/verify.png
/Users/shuhsing/Library/Android/sdk/platform-tools/adb -s emulator-5554 pull /sdcard/verify.png /tmp/verify.png
